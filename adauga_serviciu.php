...
{   $i=0;
   ...
   {    
        $sql = "INSERT INTO Servicii (Nume,[ID Departament]) VALUES ('$nume','$departament')";
...
<body>
 ...
 <body style='font-family: sans-serif;background: linear-gradient(to right, #ff7070, #84c5fa)'>  
    ...
    <form action='adauga_serviciu.php' nctype='multipart/form-data' method='post'>
  
    Nume: 
    <input type='text' name='Nume' placeholder='ex.Curatat Interior'/>
...
"
<html>
<head><title>Adauga Serviciu</title></head>
<body>
